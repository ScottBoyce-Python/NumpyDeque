...
def test_popleft(filled_deque):
    ...
    assert np.array_equal(filled_deque.deque, [2, 3, 4, 5])
    value = filled_deque.popleft()
    assert value == 2
    assert len(filled_deque) == 3
    assert np.array_equal(filled_deque.deque, [3, 4, 5])
...
def test_pop(filled_deque):
    ...
    assert value == 5
    assert len(filled_deque) == 4
    assert np.array_equal(filled_deque.deque, [1, 2, 3, 4])

    value = filled_deque.pop()
    assert value == 4
    assert len(filled_deque) == 3
    assert np.array_equal(filled_deque.deque, [1, 2, 3])
...
def test_pop_popleft(filled_deque):
    ...
    assert value == 1
    assert len(filled_deque) == 3
    assert np.array_equal(filled_deque.deque, [2, 3, 4])

    value = filled_deque.popleft()
    assert value == 2
    assert len(filled_deque) == 2
    assert np.array_equal(filled_deque.deque, [3, 4])

    value = filled_deque.pop()
    assert value == 4
    assert len(filled_deque) == 1
    assert np.array_equal(filled_deque.deque, [3])

    value = filled_deque.popleft()
    assert value == 3
    assert len(filled_deque) == 0
    assert np.array_equal(filled_deque.deque, [])
...
def test_drop_right_shift(filled_deque):
    ...
    assert value == 2
    assert len(filled_deque) == 4
    assert np.array_equal(filled_deque.deque, [1, 3, 4, 5])
...
def test_drop_left_shift(filled_deque):
    ...
    assert value == 4
    assert len(filled_deque) == 4
    assert np.array_equal(filled_deque.deque, [1, 2, 3, 5])
...
def test_repeated_drop_put(filled_deque):
    ...
    assert np.array_equal(filled_deque.deque, [44, 1, 2, 5, 33])
